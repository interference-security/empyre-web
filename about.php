        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    EmPyre Web utilizes the <a href="https://github.com/interference-security/empyre-web/">EmPyre REST API Server</a>. It is a web interface for using <a href="https://github.com/EmpireProject/EmPyre">EmPyre</a>.<br><br>
