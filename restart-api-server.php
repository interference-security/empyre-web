...
if(!empty($arr_result))
{
    if(array_key_exists("success", $arr_result))
    {
        ...
        elseif($temp_resp == false)
            $empire_restart = "<div class='alert alert-danger'><span class='glyphicon glyphicon-remove'></span> Failed to restart EmPyre REST API Server.</div>";
        else
...
<html lang="en">
<head>
	<title>EmPyre: Restart API Server</title>
    ...
    <div class="container">
        ...
        <div class="panel-group">
            <div class="panel panel-primary">
                <div class="panel-heading">Restart EmPyre REST API Server</div>
